...
namespace d3d_vtable {
	...
	static void init_imgui(void* device, bool is_d3d11 = false) noexcept
	{
		...
		colors[ImGuiCol_Tab] = ImVec4(0.42f, 0.42f, 0.42f, 0.392f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.82f, 0.82f, 0.82f, 0.392f);
		colors[ImGuiCol_TabActive] = ImVec4(0.82f, 0.82f, 0.82f, 0.392f);
